...
/*@ requires hyp_physvirt_offset |-> ?offset &*&                                          /*SPEC*/
             0 <= offset && 0 <= phys - offset && phys - offset < UINTPTR_MAX; @*/        /*SPEC*/
/*@ ensures hyp_physvirt_offset |-> offset &*&                                            /*SPEC*/
	    result == (void*) (phys - offset); @*/                                        /*SPEC*/
{
...
/*@ requires hyp_physvirt_offset |-> ?offset &*&                                                                    /*SPEC*/
             0 <= offset && 0 <= (phys_addr_t)addr + offset && (phys_addr_t) addr + offset < UINTPTR_MAX; @*/       /*SPEC*/
/*@ ensures hyp_physvirt_offset |-> offset &*&                                                                      /*SPEC*/
            result == (phys_addr_t)addr + offset; @*/                                                               /*SPEC*/
{
